...
public static class WeakEventManager
{
	...
	public static void AddHandler<TEventSource>
	(TEventSource source, string eventName, NotifyEventHandler handler)
	{
		EventInfo eventInfo = typeof(TEventSource).GetRuntimeEvent(eventName);
		registeredEvents.Add(
			new WeakEvent(source, eventInfo, handler));
	...
	public static void AddHandler<TEventSource, TEventArgs>
		(TEventSource source, string eventName, TypedEventHandler<TEventSource, TEventArgs> handler)
	{
		EventInfo eventInfo = typeof(TEventSource).GetRuntimeEvent(eventName);
		registeredEvents.Add(
			new WeakEvent(source, eventInfo, handler));
